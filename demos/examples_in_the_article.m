...
% Calling the model selection procedure without tuning (the default value
% for the estimation method is 'bic' and the default value for the
% penalization constant is 1)
...
[tau3, q4] = estimate_discreteSeqROCTM(X3, Y3, A, 'MaxTreeHeight', max_height);
